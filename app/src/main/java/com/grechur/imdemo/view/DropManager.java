...
public class DropManager {
    ...
    // single instance
    private static com.netease.nim.uikit.common.ui.drop.DropManager instance;

    public static synchronized com.netease.nim.uikit.common.ui.drop.DropManager getInstance() {
        if (instance == null) {
            instance = new com.netease.nim.uikit.common.ui.drop.DropManager();
        }
    ...
    private com.netease.nim.uikit.common.ui.drop.DropManager.IDropListener listener; // 红点拖拽动画监听器

    private boolean enable;
    private int[] explosionResIds = new int[]{
            com.netease.nim.uikit.R.drawable.nim_explosion_one,
            com.netease.nim.uikit.R.drawable.nim_explosion_two,
            com.netease.nim.uikit.R.drawable.nim_explosion_three,
            com.netease.nim.uikit.R.drawable.nim_explosion_four,
            com.netease.nim.uikit.R.drawable.nim_explosion_five
    };
    ...
    public void setDropListener(com.netease.nim.uikit.common.ui.drop.DropManager.IDropListener listener) {
