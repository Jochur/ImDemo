...
public class DropFake extends View {
    ...
    private com.netease.nim.uikit.common.ui.drop.DropFake.ITouchListener touchListener;

    public DropFake(Context context, AttributeSet attrs) {
        super(context, attrs);

        com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().initPaint();
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        // circle
        canvas.drawCircle(circleX, circleY, radius, com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().getCirclePaint());
        // text
        if (!TextUtils.isEmpty(text)) {
            canvas.drawText(text, circleX, circleY + com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().getTextYOffset(),
                    com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().getTextPaint());
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().isEnable()) {
            return super.onTouchEvent(event);
        }
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (com.netease.nim.uikit.common.ui.drop.DropManager.getInstance().isTouchable()) {
    ...
    public void setTouchListener(com.netease.nim.uikit.common.ui.drop.DropFake.ITouchListener listener) {
