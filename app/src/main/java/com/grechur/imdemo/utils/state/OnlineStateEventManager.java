...
public class OnlineStateEventManager {
    ...
    private static void registerNetTypeChangeObserver() {
        ...
        YunxinCache.getContext().registerReceiver(receiver, filter);
    }
    ...
    public static void publishOnlineStateEvent(boolean force) {
        ...
        int netState = getNetWorkTypeName(YunxinCache.getContext());
...
//        }
    ...
    private static boolean enableOnlineStateEvent() {
        String packageName = YunxinCache.getContext().getPackageName();
        return enable = (packageName != null && packageName.equals("com.grechur.imdemo"));
    }
}
